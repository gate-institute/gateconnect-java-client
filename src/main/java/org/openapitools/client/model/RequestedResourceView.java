...
public class RequestedResourceView {
  ...
  **/
  ...
  public RequestedResourceView remoteId(URI remoteId) {
  ...
  **/
  ...
  public RequestedResourceView publisher(URI publisher) {
  ...
  **/
  ...
  public RequestedResourceView license(URI license) {
  ...
  **/
  ...
  public RequestedResourceView sovereign(URI sovereign) {
  ...
  **/
  ...
  public RequestedResourceView endpointDocumentation(URI endpointDocumentation) {
  ...
  **/
  ...
  public RequestedResourceView samples(List<URI> samples) {
    
    this.samples = samples;
    return this;
  }

  public RequestedResourceView addSamplesItem(URI samplesItem) {
  ...
  **/
  ...
  public RequestedResourceView links(Map<String, Link> links) {
    
    this.links = links;
    return this;
  }

  public RequestedResourceView putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationDate, requestedResourceView.creationDate) &&
        ...
        Objects.equals(this.links, requestedResourceView.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationDate, modificationDate, remoteId, title, description, keywords, publisher, language, license, version, sovereign, endpointDocumentation, paymentModality, samples, additional, links);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RequestedResourceView
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RequestedResourceView.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestedResourceView is not found in the empty JSON string", RequestedResourceView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RequestedResourceView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestedResourceView` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestedResourceView.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestedResourceView' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestedResourceView> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestedResourceView.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestedResourceView>() {
           @Override
           public void write(JsonWriter out, RequestedResourceView value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestedResourceView read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RequestedResourceView given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RequestedResourceView
  * @throws IOException if the JSON string is invalid with respect to RequestedResourceView
  */
  public static RequestedResourceView fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestedResourceView.class);
  }

 /**
  * Convert an instance of RequestedResourceView to an JSON string
  *
  * @return JSON string
  */
